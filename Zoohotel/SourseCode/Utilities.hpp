...
namespace ZooHotel
{
	...
	namespace DateTime
	{
		...
		//solutions above are naive and don't really got anything going for automation,
		//for storing the time and date t the same time there is a specific data type that is usually used: std::chrono::time_point, this type can be converted into a human-readable
